    ...
    <div class="homepage" id="homepage">
      <div class="row ms-5" style="color: white;">
        <div class="col mb-5">
          ...
          <h2 class="fw-bold">An <span style="color: #76ABAE;">aspiring</span>
            Developer.</h2>
          <div class="col-10 mt-4">
            <p style="font-size: 17px;">With extensive expertise in Web Development and Database Management, a fresh
              graduate whose eager to
              learn
              and grow. Let's make something happen!</p>
          </div>
          ...
          <div class="row mt-4" style="gap: 50px;">
            <!-- CV -->
            <div class="col-4">
              <a href="#" id="downloadCV">
                <div class="dcv d-flex align-items-center justify-content-center p-2"
                  style="background-color: #EEEEEE; color: #222831; border-radius: 20px; border: 2px solid #222831;">
            ...
            <div class="col-4">
              <a href="#" id="downloadRESUME">
                <div class="dresume d-flex align-items-center justify-content-center p-2"
                  style="background-color: #222831; color:#EEEEEE; border-radius: 20px; border: 2px solid #EEEEEE;">
